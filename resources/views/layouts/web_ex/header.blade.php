        ...
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" id="languageDropdownBtn"
                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img id="header-lang-img" src="{{asset('web/assets/images/loading.webp')}}" alt="Header Language"
                            height="20" class="rounded">
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            <a class="dropdown-item notify-item language py-2" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" data-locale="{{ $localeCode }}">
                                <img src="{{ asset('web/assets/images/flags/'.$properties['native']).'.svg'}}" alt="user-image" class="me-2 rounded" height="18">
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <img class="rounded-circle header-profile-user"
                                src="{{asset(''.Auth()->user()->logo)}}" alt="Header Avatar">
                                @else
                                <img class="rounded-circle header-profile-user"
                                src="{{asset('web/assets/images/users/avatar-1.jpg')}}" alt="Header Avatar">
                                @endif
